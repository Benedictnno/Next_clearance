...
export type StudentDoc = { _id?: any; userId: number; firstName: string; lastName: string; matricNumber: string; department: string; faculty: string; level: string; createdAt?: Date; updatedAt?: Date }
